...
from ecommerce.views import ClientUpdateDestroyAPIView, ClientCreateAPIView, ClientModelViewSet, ShopClientListAPIView
...
urlpatterns = [
    ...
    path('sign-up', ClientCreateAPIView.as_view(), name='sign-up'),
